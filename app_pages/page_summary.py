...
def page_summary_body():
    ...
    st.markdown(
        "The dataset contains 983 featured photos of pizza variations, as well as 983 photos of food that is not pizza. This dataset is sourced from [Kaggle](https://www.kaggle.com/code/rasikagurav/pizza-or-not-pizza/input)."
    )
